...
- Logging-library version coverage lives in `Frameworks/PackageVersionMatrixTests.cs` (restored NuGet compile assets as metadata references). Do not add a test project per Serilog/NLog/MEL/ZLogger version. See `docs/package-version-testing.md`.
